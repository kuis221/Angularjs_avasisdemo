app.controller('BankDrawPaymentDetailsCtrl',
    ['$scope', '$state', function ($scope, $state) {
        ...
        $scope.payment_details = [
            {contact: 'Bob Jones', company_name: 'Synergy Construction', phone_number: '801-580-5683', role: 'General Contractor', project_name: 'Wilmington 47', payment_application: 20358, split_payment: 'No', payment_amount: 20358, company_name: 'Synergy Construction', payment_form: 'Check', varience: 0},
            {contact: 'John Steel', company_name: 'L&L Steel Erection ', phone_number: '861-518-1636', role: 'Subcontractor', project_name: 'Wilmington 47', payment_application: 2139.01, split_payment: 'No', payment_amount: 2139.01, company_name: 'Steel Supplier Inc', payment_form: 'Check', varience: 0},
            ...
            {contact: 'Dave Gebo', company_name: 'On Top Roofing', phone_number: '835-513-6185', role: 'Subcontractor', project_name: 'Wilmington 47', payment_application: 35000, split_payment: 'No', payment_amount: 35000, company_name: 'On Top Roofing', payment_form: 'Check', varience: 0},
            ...
            {contact: 'Dave Musgrove', company_name: 'Premier Heating & Air, Inc.', phone_number: '861-569-6688', role: 'Subcontractor', project_name: 'Wilmington 47', payment_application: 14580, split_payment: 'No', payment_amount: 14580, company_name: 'Premier Heating & Air, Inc.', payment_form: 'Check', varience: 0},
